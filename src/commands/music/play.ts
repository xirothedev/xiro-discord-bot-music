...
import { EmbedBuilder, userMention, type VoiceBasedChannel } from "discord.js";
            ...
            return await msg.edit({
                ...
                embeds: [
                    embed
                        ...
                        .setDescription(
                            `Đã xảy ra lỗi. Vui lòng báo mã lỗi \`${(await log).logId}\` ${userMention(config.users.ownerId)}!`,
                        ),
                ],
            });
        }
