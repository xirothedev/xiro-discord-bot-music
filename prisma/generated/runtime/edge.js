...
var Ci = Fe((Ke) => {
    ...
    T.prototype.compare = function (e, t, r, n, i) {
        if (
            (de(e, Uint8Array) && (e = T.from(e, e.offset, e.byteLength)), !T.isBuffer(e))
        )
            throw new TypeError(
...
C.minus = C.sub = function (e) {
    ...
    for (
        h && ((t = f), (f = v), (v = t), (e.s = -e.s)), s = f.length, n = v.length - s;
        n > 0;
        --n
    )
        f[s++] = 0;
...
function I(e, t, r, n) {
    ...
    e: if (t != null) {
        ...
        if (
            ((n =
                n || t < 0 || h[v + 1] !== void 0 || (s < 0 ? g : g % J(10, i - s - 1))),
            (f =
                r < 4
                    ? (l || n) && (r == 0 || r == (e.s < 0 ? 3 : 2))
                    : l > 5 ||
...
function ho(e, t, r, n) {
    ...
    for (_ = !1; ; ) {
        if (
            (r % 2 && ((o = o.times(t)), ao(o.d, s) && (i = !0)), (r = X(r / 2)), r === 0)
        ) {
...
var pt = class {
    ...
    prometheus(t) {
        return (
            zo(this._client), this._client._engine.metrics({ format: "prometheus", ...t })
        );
    }
    json(t) {
